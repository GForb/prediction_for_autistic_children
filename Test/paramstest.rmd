...
#| warning: false
for (wav in 1:waves) {
  wave <- make_summary_by_wave(data, waves)
  wave <- wave[[wav]] |> 
    filter(name %in% params$variables) |> 
    gt() |> 
    gt_theme_espn()
...
for (variable in params$variables) {
  plot <- make_raincloudplot(get(set_name)[[variable]], paste(variable, "score"), params$colour)
...
#| warning: false
# for (variable in params$variables) {
#   gif <- make_raincloudplot_wave(data, waves, variable, paste(variable, "score by wave"), params$colour)
#   create_gif(gif)
#   # for (wav in 1:waves) {
#   #   first <- make_summary_by_wave(data, waves)
#   #   first[[wav]] |>
#   #   filter(name == variable) |>
#   #     gt() |>
