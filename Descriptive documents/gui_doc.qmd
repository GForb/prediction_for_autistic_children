...
```{r}
#| warning: false
wave_1 <- make_summary_by_wave(gui_data, 3)
wave_1 <- wave_1[[1]] |> 
...
```{r}
#| warning: false
wave_2 <- make_summary_by_wave(gui_data, 3)
wave_2 <- wave_2[[2]] |> 
  filter(name %in% c("age", "gender", "sdq_emot_p", "sdq_cond_p", "sdq_hyp_p", "sdq_peer_p", "sdq_pro_p", "sdq_tot_p"))
wave_2|> 
  gt() |> 
...
```{r}
#| warning: false
wave_3 <- make_summary_by_wave(gui_data, 3)
wave_3 <- wave_3[[3]] |> 
  filter(name %in% c("age", "gender", "sdq_emot_p", "sdq_cond_p", "sdq_hyp_p", "sdq_peer_p", "sdq_pro_p", "sdq_tot_p"))
wave_3|> 
  gt() |> 
...
```{r}
#| warning: false
make_raincloudplot(gui_data$sdq_tot_p, "SDQ Total Problems Score", "blue4")
make_summary_table(gui_data) |> 
...
```{r}
#| warning: false
sdq_tot <- make_raincloudplot_wave(gui_data, 3, "sdq_tot_p", "SDQ Total Problems Score by Wave", "blue4")
create_gif(sdq_tot)
```

```{r}
#| warning: false
first <- make_summary_by_wave(gui_data, 3)
first[[1]] |> 
  filter(name == "sdq_tot_p") |> 
  gt() |> 
  tab_header("Wave 1") |> 
  gt_theme_espn()
second <- make_summary_by_wave(gui_data, 3)
second[[2]] |> 
  filter(name == "sdq_tot_p") |> 
  gt() |> 
  tab_header("Wave 2") |> 
  gt_theme_espn()
third <- make_summary_by_wave(gui_data, 3)
third[[3]] |>
  filter(name == "sdq_tot_p") |>
  gt() |>
  tab_header("Wave 3") |> 
...
```{r}
#| warning: false
make_raincloudplot(gui_data$sdq_emot_p, "SDQ Emotinal Problems scale", "darkmagenta")
make_summary_table(gui_data) |> 
...
```{r}
#| warning: false
sdq_emot <- make_raincloudplot_wave(gui_data, 3, "sdq_emot_p", "SDQ Emotinal Problems scale", "darkmagenta")
create_gif(sdq_emot)
```
...
```{r}
#| warning: false
make_raincloudplot(gui_data$sdq_cond_p, "SDQ Conduct Problems Scale", "olivedrab4")
make_summary_table(gui_data) |> 
...
```{r}
#| warning: false
sdq_cond <- make_raincloudplot_wave(gui_data, 3, "sdq_cond_p", "SDQ Conduct Problems Scale", "olivedrab4")
create_gif(sdq_cond)
```
...
```{r}
#| warning: false
make_raincloudplot(gui_data$sdq_hyp_p, "SDQ Hyperactivity Scale", "aquamarine4")
make_summary_table(gui_data) |> 
...
```{r}
#| warning: false
sdq_hyp <- make_raincloudplot_wave(gui_data, 3, "sdq_hyp_p", "SDQ Hyperactivity Scale", "aquamarine4")
create_gif(sdq_hyp)
```
...
```{r}
#| warning: false
make_raincloudplot(gui_data$sdq_peer_p, "SDQ Peer Problems Scale", "coral1")
make_summary_table(gui_data) |> 
...
```{r}
#| warning: false
sdq_peer <- make_raincloudplot_wave(gui_data, 3, "sdq_peer_p", "SDQ Peer Problems Scale", "coral1")
create_gif(sdq_peer)
```
...
```{r}
#| warning: false
make_raincloudplot(gui_data$sdq_pro_p, "SDQ Prosociality Scale", "firebrick1")
make_summary_table(gui_data) |> 
...
```{r}
#| warning: false 
sdq_pro <- make_raincloudplot_wave(gui_data, 3, "sdq_pro_p", "SDQ Prosociality Scale", "firebrick1")
create_gif(sdq_pro)
```
