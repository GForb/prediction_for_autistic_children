...
data_raw  <- readxl::read_xlsx(here::here(data_folder, "ELENA_DATA_VABS_20250130_protege.xlsx")) 
...
data <- data_raw |> 
  mutate(age_vabs1 = as.numeric(agevinelandV0),
         ...
         base_maternal_education = case_when(niveau_etude_mere == "3" ~ 1,
                                       niveau_etude_mere == "2" ~ 0,
                                       niveau_etude_mere == "1" ~ 0,
