...
rm(list = ls())
gc()
source(here::here("R scripts", "config_v2.R"))
...
## Pooling ----
  ...
  tictoc::tic()
  set.seed(42345234)
  create_full_results_table(results_folder_vabs)
  tictoc::toc() 
...
# tictoc::tic()
# set.seed(366345634)
# create_full_results_table(results_folder_cbcl)
# tictoc::toc() 
# 
# ##  Running models for model reporting
# tictoc::tic()
...
# tictoc::tic()
# set.seed(949493)
# create_full_results_table(results_folder_sdq)
# tictoc::toc() 
# 
# ##  Running models for model reporting
